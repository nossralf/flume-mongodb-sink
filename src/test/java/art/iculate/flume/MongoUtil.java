...
public class MongoUtil {
  ...
  public static List<String> getJsonDocuments(
      String host, int port, String user, String password, String database, String collection) {
    MongoClient client =
        MongoClients.create(
    ...
    for (Document cur :
        client.getDatabase(database).getCollection(collection).find().projection(excludeId())) {
